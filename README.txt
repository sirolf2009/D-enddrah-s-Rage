...
This is the readme for D'endrrah's rage, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. DendrrahsRage) > Ok.
...
- To run the project find DendrrahsRage.java (which will be in under src/main/java/com/dendrrahsrage) and right click > Run 'DendrrahsRage'
